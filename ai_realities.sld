...
<header color=cyan>REALITY: AI CREATES ANAMORPHIC ILLUSIONS</header>

<image path="anamorphic_illusion.png" width="40%"/>
...
<header color=cyan>REALITY: AI HAS NO RESPONSIBITY</header>
...
<image path="tech-layoffs.jpg" width="40%"/>

---

<header color=cyan>REALITY: AI TRIGGERED TECH LAYOFFS</header>
...
<footnote>Ref: BusinessInsider</footnote>
...
<header color=cyan>REALITY: AI INCREASED DEMAND FOR MORE DEVELOPERS</header>

<image path="jevons_paradox.jpg" width="30%"/>
<p max-width=60 align=left>
...
<header color=cyan>REALITY: AI HAS NO CLUE ABOUT PAST DECISIONS</header>

<p max-width=60 align=left>
    AI cannot see the <color fg="red">10-year legacy debt</color> of Enterprises

    LLMs live in a <color fg="yellow">context window,</color> not a codebase
    They don't know the <color fg="yellow">"Why"</color> of 2016
    Managing debt requires <color fg="yellow">historical judgment</color>
</p>
...
<p max-width=60 align=left>
    ...
    ==> We are <color fg="yellow">deleting</color> and <color fg="yellow">fixing</color> code faster than ever before
    ==> <color fg="yellow">Generating Slop</color> at light speed
    ==> We are drowning in <color fg="yellow">"Slop Creep"</color>
</p>
...
<image path="vibe-coding-platforms-customer-churn.jpg" width="40%"/>
<p max-width=60 align=left>
...
<header color=cyan>REALITY: AI DOES NOT IMPROVE SLOPPY MINDSETS</header>

<image path="spiderman_pointing_meme.jpg" width="40%"/>
<p max-width=80 align=center>
    The companies that have <color fg="red">organizational</color>
    and <color fg="red">profession-wise</color> dysfunctions
    won't be able to get the benefit from AI
    without <color fg="yellow">changing the mindset</color>
</p>
...
<header color=cyan>REALITY: AI CAN CHEAT (AND APPOLOGISE)</header>

<p max-width=60 align=left>
    AI can easily <color fg="red">cheats</color> on your tests

    ==> Tell AI: "Make the tests <color fg="yellow">pass</color>."
    ==> AI: <color fg="yellow">Deletes the assertions.</color>
    ==> Tests pass. <color fg="yellow">Logic is broken.</color>
</p>
...
<image path="mount_stupid.png" width="35%"/>
<p max-width=60 align=center>
    THAT'S <color fg="cyan">MAGIC</color>! - Reaction of a <color fg="red">novice</color> in programming
    THAT'S <color fg="cyan">RISKY</color>! - Reaction of an <color fg="red">expert</color> in programming
</p>
