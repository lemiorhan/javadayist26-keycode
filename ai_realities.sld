...
<p max-width=60 align=center>
    AI doesn't care about your <color fg="red">Complexity</color>

    ==> It writes <color fg="yellow">correct-looking</color> but <color fg="red">inefficient</color> logic
    ==> Works with 10 records. <color fg="red">Crashes with 10 Million.</color>
    ==> <color fg="cyan">Performance</color> requires human insight
</p>

/* PRESENTER NOTES:

Yapay zeka için kodun "doğru görünmesi", "verimli çalışmasından" daha önemlidir.
AI genellikle karmaşıklık analizi yapmaz; size en basit yolu sunar,
ki bu genellikle iç içe geçmiş döngüler ve O(N²) faciaları demektir.

Donald Knuth'un ünlü sözünü hatırlayalım:
"We should forget about small efficiencies, say about 97% of the time:
premature optimization is the root of all evil. Yet we should not pass up our opportunities in that critical 3%."

> Küçük verimlilik artışlarını, diyelim ki %97 oranında, bir kenara bırakmalıyız:
Erken optimizasyon, tüm sorunların kaynağıdır. Ancak o kritik %3’lük kısımda karşımıza çıkan fırsatları da kaçırmamalıyız.

Zamanın büyük kısmında, çok küçük performans kazanımları için uğraşmak gereksizdir. Asıl önemli olan,
gerçekten fark yaratan az sayıdaki kritik yeri doğru tespit edip orada iyileştirme yapmaktır.

Geliştirme ortamınızda 10 kayıtla test ederken her şey harika görünür.
Canlıya geçip 10 milyon kayıtla karşılaştığınızda sisteminiz çöker.
